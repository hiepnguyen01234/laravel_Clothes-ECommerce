...
@section('content')
    ...
    <section class="section-content">
        <div class="container">
            ...
            <!-- ========================= SECTION ITEMS FROM DATABASE ========================= -->
            <hr>
            <div class="row">
                @if (isset($products))
                    @foreach ($products as $item)
                        <div class="col-md-3">
                            <div href="/product/{{ $item->id }}" class="card card-product-grid">
                                <a href="/product/{{ $item->id }}" class="img-wrap"> <img src="{{ Asset($item->image_path) }}"
                                        alt="{{ $item->name }}"> </a>
                                <figcaption class="info-wrap">
                                    ...
                                    <div class="price mt-1">${{ number_format($item->price) }}.00</div>
                                    <!-- price-wrap.// -->
                                </figcaption>
                            </div>
                        </div> <!-- col.// -->
            ...
            <hr>
            <!-- ========================= SECTION ITEMS FROM DATABASE END// ========================= -->
